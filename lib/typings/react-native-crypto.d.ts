declare module '@koffre_npm/react-native-crypto' {
  ...
  namespace Pbkdf2 {
    ...
    export function hash64(passwordBase64: string, saltBase64: string, iterations: number, keyLen: number, hash: 'SHA1' | 'SHA224' | 'SHA256' | 'SHA384' | 'SHA512'): Promise<string>;
  }
  ...
  namespace Rsa {
    ...
    export function decrypt64OAEP(data64: string, key: string): Promise<string>;
